...
QString areaText = 
  pfmPage::tr ("This is the area file name that can be selected using the <b>Browse...</b> button.  This field is not "
               ...
               "survey planner area format (.ARE), the NAVO generic area format (.are), the Army Corps area format (.afs), "
               "or ESRI shape file format.  Shape files must be either Polygon, PolygonZ, PolygonM, PolyLine, PolyLineZ, or "
               "PolyLineM format and must be geographic (not projected).  For PolyLine files the first point will be "
               "duplicated to close the polygon.  Whether using Polygon or PolyLine files, only the first shape will be used "
               "if there are multiple shapes in the file.<br><br>"
...
QString areaBrowseText = 
  pfmPage::tr ("Use this button to select an area file.  The area file may be in the ISS-60 "
               "survey planner area format (.ARE), the NAVO generic area format (.are), the Army Corps area format (.afs), "
               "or ESRI shape file format.  Shape files must be either Polygon, PolygonZ, PolygonM, PolyLine, PolyLineZ, or "
               "PolyLineM format and must be geographic (not projected).  For PolyLine files the first point will be "
               "duplicated to close the polygon.  Whether using Polygon or PolyLine files, only the first shape will be used "
...
QString mosaicText = 
  pfmPage::tr ("This is the associated GeoTIFF mosaic file if one is available.");

QString mosaicBrowseText = 
  pfmPage::tr ("Use this button to select the associated GeoTIFF mosaic file if one is available.");
