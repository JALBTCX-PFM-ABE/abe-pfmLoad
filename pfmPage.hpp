...
public:
  ...
  pfmPage (QWidget *parent = 0, PFM_DEFINITION *pfmDef = NULL, PFM_GLOBAL *pfmg = NULL, int32_t page_num = 0);
...
protected slots:
  ...
  void slotMinDepthChanged (double value);
  void slotMaxDepthChanged (double value);
